...
public:
  ...
  void compress(const IntegerCaloSamples& ics, const std::vector<int>& fineGrain, HcalUpgradeTriggerPrimitiveDigi& digi, std::vector<std::pair<float,float>>& shortLongEnergies) const;
